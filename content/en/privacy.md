...
If the Photographer wishes to use the client's images on the website https://www.beebifoto.eu or on the Photographer's pages in social networks, then only if he has received written permission from the client by e-mail or when filling out a questionnaire.
